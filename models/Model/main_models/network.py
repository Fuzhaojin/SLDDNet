...
class SLDDNet(nn.Module):
    ...
    def forward(self, x, y, img_name="None"):
        ...
        # Deep supervision---add--
        loss41 = self.loss4(totalout)
        loss42 = self.loss4(totalout)
        lay1list.append(loss41)
        lay2list.append(loss42)
        ...
        # Deep supervision---add--
        loss32 = self.loss3(totalout)
        lay2list.append(loss32)
        ...
        # Deep supervision---add--
        loss22 = self.loss2(totalout)
        lay2list.append(loss22)
        ...
        # Deep supervision---add--
        loss12 = self.loss1(totalout)
        lay2list.append(loss12)
